import pygame
from config import DINO_START_X, DINO_WIDTH, DINO_HEIGHT, GRAVITY, JUMP_VELOCITY, GROUND_Y, POTIONS_NEEDED
...
class Dino:
    ...
    def __init__(self): 
        ...
        self.image_running = pygame.image.load("assets/dino4.png")
        self.image_ducking = pygame.image.load("assets/dino_ducking2.png")
        self.image_running = pygame.transform.scale(self.image_running, (DINO_WIDTH, DINO_HEIGHT))
        self.image_ducking = pygame.transform.scale(self.image_ducking, (DINO_WIDTH-20, DINO_HEIGHT // 2))
    ...
    def spit_fire(self, fireballs):
        '''
        Spits a fireball if the Dino has potions.
        @param fireballs: The list of active fireballs in the game.
        '''
        if self.potions >= POTIONS_NEEDED:
            # Fireball starts at the middle-right of the Dino
            fireball = Fireball(self.rect.right, self.rect.centery-15)  
            fireballs.append(fireball)
            self.potions -= POTIONS_NEEDED  # Decrease potion count
